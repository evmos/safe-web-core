...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;{'Evmos Safe'}&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a
    ...
    <h4>4.1. When visiting our website and using {'Evmos Safe'}</h4>
    <p>
      When visiting our website or using {'Evmos Safe'}, we may collect and process personal data. The data will be
    ...
    <ol start={4}>
      <li>
        ...
        the {'Evmos Safe'}, we process your
        <ol>
    ...
    <p>
      {'Evmos Safe'} mobile apps are distributed via{' '}
...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>{'Evmos Safe – Privacy policy'}</title>
      </Head>
